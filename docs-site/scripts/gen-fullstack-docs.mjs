...
${code(`import { createCacheEngine, createMemoryStore } from 'what-cache';
...
${code(`import { createScheduler } from 'what-cache';
...
${code(`import { createRevalidateWebhook } from 'what-cache';
...
import { createCacheEngine, createMemoryStore } from 'what-cache';
